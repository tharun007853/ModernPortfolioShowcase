  ...
  const projects = [
    {
      ...
      description:
        "A comprehensive bus booking system built with Java. Features include seat selection, booking management, and database integration for storing reservation data.",
      icon: Bus,
      gradient:
    ...
    },
    {
      ...
      description:
        "Machine learning model that predicts flower types (Setosa, Versicolor, Virginica) based on sepal and petal measurements. Built with Python and deployed using Streamlit framework.",
      icon: Flower,
      gradient:
    ...
    },
    {
      ...
      description:
        "A mobile application for food ordering built with Java in Android Studio. Features include user authentication, menu browsing, cart management, and order tracking functionality.",
      icon: Utensils,
      gradient:
              ...
              <Card className="rounded-lg overflow-hidden shadow-lg hover-lift glow-on-hover h-full">
                ...
                >
                  <div className="text-center">
                    <project.icon
                      className={`h-12 w-12 ${project.iconColor} mb-4 mx-auto`}
                    />
                ...
                <CardContent className="p-6">
                  ...
                  <div className="flex justify-between items-center">
                    <div className="text-sm text-gray-500 dark:text-gray-400 flex items-center">
                      <project.statusIcon
                        className={`h-4 w-4 ${project.statusColor} mr-1`}
                      />
                      {project.status}
                    </div>
